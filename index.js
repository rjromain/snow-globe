...
function SnowFlakes(canvas) {
	...
	for (var s = 0; s < this.canvas.width; s += 1) {
		...
		this.image_curves.wide_high_arc.y_pos.push( Math.floor( Math.pow(s - this.middle, 2) * 0.01 ) + 50 );
	}
}
...
SnowFlakes.prototype.render = function () {
	...
	for (var b = 0; b < num_images; b += 1) {
		...
		if (image.animating_image === true) {
			this.context.drawImage(image.image_moving, image.x_pos, image.y_pos);
		} else {
			this.context.drawImage(image.image_stopped, image.x_pos, image.y_pos);
		}
...
var snowid = 0;
var allSnows = [];
var globes = document.getElementsByClassName('globe-img');

function makeItSnow(thecanvas, flakes) {
	var snowShow = new SnowFlakes(thecanvas),
		total_flakes = flakes,
		flake_width = 5,
		flake_height = 5;		
	...
	// Add images
	/*
	snowShow.addImage(220, 220, 0, 0, 'narrow_mid_arc', -1, 0, -0.07, '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Kipp_Resting.png', '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Kipp_Floating.png');
	snowShow.addImage(250, 250, 0, 0, 'narrow_arc', 1, -2, 0.1, '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Brian_Resting.png', '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Brian_Floating.png');
	snowShow.addImage(250, 250, 0, 0, 'narrow_high_arc', -1, 0.7, 0.15, '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Bob_Resting.png', '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Bob_Floating.png');
	snowShow.addImage(250, 250, 0, 0, 'wide_arc', -1, 0.7, 0.02, '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Andy_Resting.png', '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Andy_Floating.png');
	snowShow.addImage(250, 250, 0, 0, 'wide_high_arc', -1, 0.7, 0.02, '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Jess_Resting.png', '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Jess_Floating.png');
	snowShow.addImage(250, 250, 0, 0, 'medium_arc', 1, 0.1, 0.05, '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Brandon_Resting.png', '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Brandon_Floating.png');
	snowShow.addImage(250, 250, 0, 0, 'medium_low_arc', -1, -0.7, 0.03, '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Shanon_Resting.png', '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Shanon_Floating.png');
	snowShow.addImage(250, 250, 0, 0, 'medium_high_arc', 1, 0, 0.0087, '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Mike_Resting.png', '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Mike_Floating.png');
	snowShow.addImage(250, 250, 0, 0, 'wide_low_arc', 1, 0, -0.05, '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Maureen_Resting.png', '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Maureen_Floating.png');
	snowShow.addImage(200, 200, 0, 0, 'wide_mid_arc', -1, 0, -0.05, '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Tim_Resting.png', '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Tim_Floating.png');
	snowShow.addImage(250, 250, 0, 0, 'narrow_mid_arc', 1, 0, -0.05, '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Chris_Resting.png', '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Chris_Floating.png');
	snowShow.addImage(250, 250, 0, 0, 'wide_mid_arc', 1, 0, -0.03, '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Mason_Resting.png', '/wp-content/themes/king_design/assets/images/pages/snowglobe/heads/Mason_Floating.png');
	*/
	
	// Start the snow globe
	snowShow.startSnow();
	
	thecanvas.parentNode.snows = snowShow;
...
function shakeItUp(el, flakes) {
	if (!(el.className.includes("shook"))) {
		el.className += " shook";
		makeItSnow(el.nextElementSibling, flakes);
	}
}